      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Jalgaon CoHelp.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Jalgaon CoHelp, accessible from{" "}
            <a
              href="https://jalgaoncohelp.in"
              rel="external nofollow noopener noreferrer"
              target="_blank"
            >
              https://jalgaoncohelp.in
            </a>
          </p>
        </li>
        <li>
